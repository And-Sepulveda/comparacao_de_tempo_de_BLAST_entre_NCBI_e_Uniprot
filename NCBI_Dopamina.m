%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Avalia o tempo (em segundos) da proteína dopamina
...
figure;
hold on;
title('Media de tempo (em segundos) - dopamina no NCBI');
...
figure;
hold on;
title('Variação de tempo (em segundos) - dopamina no NCBI');
...
figure;
hold on;
title('Desvio padrão (em segundos) - dopamina no NCBI');
