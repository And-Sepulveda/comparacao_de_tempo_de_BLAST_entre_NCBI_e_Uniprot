...
seg_01 = xlsread(arquivo,'I1201:I1205');
seg_02 = xlsread(arquivo,'I1301:I1305');
seg_03 = xlsread(arquivo,'I1329:I1330');
seg_04 = xlsread(arquivo,'I1340:I1341');
seg_05 = xlsread(arquivo,'I1359:I1360');
...
ter_01 = xlsread(arquivo,'K1201:K1205');
ter_02 = xlsread(arquivo,'K1301:K1305');
ter_03 = xlsread(arquivo,'K1329:K1330');
ter_04 = xlsread(arquivo,'K1340:K1341');
ter_05 = xlsread(arquivo,'K1359:K1360');
ter_06 = xlsread(arquivo,'K1401:K1406');
ter_07 = xlsread(arquivo,'K1501:K1506');
ter_08 = xlsread(arquivo,'K1601:K1606');
ter_09 = xlsread(arquivo,'K1701:K1705');
...
ter_14 = xlsread(arquivo,'K101:K106');
...
qua_00 = xlsread(arquivo,'M1101:M1105');
qua_01 = xlsread(arquivo,'M1201:M1205');
qua_02 = xlsread(arquivo,'M1301:M1305');
qua_03 = xlsread(arquivo,'M1329:M1330');
qua_04 = xlsread(arquivo,'M1340:M1341');
qua_05 = xlsread(arquivo,'M1359:M1360');
...
qua_14 = xlsread(arquivo,'M101:M105');
...
qua_19 = xlsread(arquivo,'M601:M608');
...
qui_02 = xlsread(arquivo,'A1301:A1306');
qui_03 = xlsread(arquivo,'A1329:A1330');
qui_04 = xlsread(arquivo,'A1340:A1341');
qui_05 = xlsread(arquivo,'A1359:A1360');
...
qui_14 = xlsread(arquivo,'A101:A106');
...
sex_01 = xlsread(arquivo,'C1201:C1205');
sex_02 = xlsread(arquivo,'C1301:C1306');
sex_03 = xlsread(arquivo,'C1329:C1330');
sex_04 = xlsread(arquivo,'C1340:C1341');
sex_05 = xlsread(arquivo,'C1359:C1360');
...
sex_14 = xlsread(arquivo,'C101:C106');
...
sab_02 = xlsread(arquivo,'E1301:E1306');
sab_03 = xlsread(arquivo,'E1329:E1330');
sab_04 = xlsread(arquivo,'E1340:E1341');
sab_05 = xlsread(arquivo,'E1359:E1360');
...
figure;
hold on;
title('Media de tempo (em segundos) - dopamina no Uniprot');
...
figure;
hold on;
title('Variação de tempo (em segundos) - dopamina no Uniprot');
...
figure;
hold on;
title('Desvio padrão (em segundos) - dopamina no Uniprot');
