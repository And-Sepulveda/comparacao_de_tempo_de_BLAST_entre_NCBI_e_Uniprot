...
dom_03 = xlsread(arquivo,'G1308:G1309');
dom_04 = xlsread(arquivo,'G1314:G1315');
dom_05 = xlsread(arquivo,'G1319:G1320');
...
dom_11 = xlsread(arquivo,'G1901:G1911');
...
dom_18 = xlsread(arquivo,'G501:G508');
dom_19 = xlsread(arquivo,'G601:G609');
dom_20 = xlsread(arquivo,'G701:G706');
dom_21 = xlsread(arquivo,'G801:G808');
dom_22 = xlsread(arquivo,'G901:G908');
dom_23 = xlsread(arquivo,'G1001:G1006');

seg_00 = xlsread(arquivo,'I1101:I1106');
seg_01 = xlsread(arquivo,'I1201:I1202');
seg_02 = xlsread(arquivo,'I1301:I1302');
seg_03 = xlsread(arquivo,'I1308:I1309');
seg_04 = xlsread(arquivo,'I1314:I1315');
seg_05 = xlsread(arquivo,'I1319:I1320');
seg_06 = xlsread(arquivo,'I1401:I1406');
seg_07 = xlsread(arquivo,'I1501:I1506');
...
seg_19 = xlsread(arquivo,'I601:I608');
...
ter_03 = xlsread(arquivo,'K1308:K1309');
ter_04 = xlsread(arquivo,'K1314:K1315');
ter_05 = xlsread(arquivo,'K1319:K1320');
ter_06 = xlsread(arquivo,'K1401:K1406');
ter_07 = xlsread(arquivo,'K1501:K1506');
ter_08 = xlsread(arquivo,'K1601:K1606');
ter_09 = xlsread(arquivo,'K1701:K1708');
...
ter_16 = xlsread(arquivo,'K301:K305');
...
qua_00 = xlsread(arquivo,'M1101:M1108');
qua_01 = xlsread(arquivo,'M1201:M1202');
qua_02 = xlsread(arquivo,'M1301:M1302');
qua_03 = xlsread(arquivo,'M1308:M1309');
qua_04 = xlsread(arquivo,'M1314:M1315');
qua_05 = xlsread(arquivo,'M1319:M1320');
...
qua_19 = xlsread(arquivo,'M602:M611');
qua_20 = xlsread(arquivo,'M701:M708');
qua_21 = xlsread(arquivo,'M801:M806');
...
qui_03 = xlsread(arquivo,'A1308:A1309');
qui_04 = xlsread(arquivo,'A1314:A1315');
qui_05 = xlsread(arquivo,'A1319:A1320');
...
sex_03 = xlsread(arquivo,'C1308:C1309');
sex_04 = xlsread(arquivo,'C1314:C1315');
sex_05 = xlsread(arquivo,'C1319:C1320');
...
sab_00 = xlsread(arquivo,'E1101:E1105');
sab_01 = xlsread(arquivo,'E1201:E1202');
sab_02 = xlsread(arquivo,'E1301:E1302');
sab_03 = xlsread(arquivo,'E1308:E1309');
sab_04 = xlsread(arquivo,'E1314:E1315');
sab_05 = xlsread(arquivo,'E1319:E1320');
...
sab_15 = xlsread(arquivo,'E201:E208');
sab_16 = xlsread(arquivo,'E301:E310');
sab_17 = xlsread(arquivo,'E401:E411');
...
figure;
hold on;
title('Media de tempo (em segundos) - insulina no NCBI');
...
figure;
hold on;
title('Variação de tempo (em segundos) - insulina no NCBI');
...
figure;
hold on;
title('Desvio padrão (em segundos) - insulina no NCBI');
contourf(dias,horas,varia);
ylim([0 23]);
xlabel('Dias');
ylabel('Horas');
