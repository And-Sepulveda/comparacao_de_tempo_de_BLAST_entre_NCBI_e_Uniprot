...
% figure;
% hold on;
% title('Media de tempo (em segundos) - canal de sódio no Uniprot');
...
% figure;
% hold on;
% title('Variação de tempo (em segundos) - canal de sódio no Uniprot');
...
figure;
hold on;
title('Desvio padrão (em segundos) - canal de sódio no Uniprot');
