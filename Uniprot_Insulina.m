%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Avalia o tempo (em segundos) da proteína insulina
...
% figure;
% hold on;
% title('Variação de tempo (em segundos) - insulina no Uniprot');
...
figure;
hold on;
title('Desvio padrão (em segundos) - insulina no Uniprot');
contourf(dias,horas,varia);
ylim([0 23]);
xlabel('Dias');
ylabel('Horas');
